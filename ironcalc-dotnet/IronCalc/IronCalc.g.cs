...
namespace IronCalc.Native
{
    internal static unsafe partial class NativeMethods
    {
        ...
        internal static extern CreateModelContextResult load_from_xlsx_bytes(byte* buffer, int length, byte* locale, byte* timezone, byte* language_id, byte* name);

        [DllImport(__DllName, EntryPoint = "new_empty", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        internal static extern CreateModelContextResult new_empty(byte* name, byte* locale, byte* timezone, byte* language_id);
